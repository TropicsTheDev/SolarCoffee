...
namespace SolarCoffee.Test
{
  public class TestCustomerService
  {
    ...
    public void CustomerService_GetsAllCustomers_GivenTheyExist()
    {
      ...
      service.CreateCustomer(new Customer { Id = 123223 });
      service.CreateCustomer(new Customer { Id = 153654 });
    ...
    public void CustomerService_CreatesCustomer_GivenNewCustomerObject()
    {
      ...
      service.CreateCustomer(new Customer { Id = 55555 });

      context.Customers.Single().Id.Should().Be(55555);
    }
